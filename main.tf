...
locals {
  ...
  onprem_configure_dns_command  = "Add-DnsServerConditionalForwarderZone -Name ${var.core_hub_active_directory_domain} -MasterServers ${azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint.ip_configurations.0.private_ip_address} -PassThru"
  onprem_configure_dns_command2 = "Add-DnsServerConditionalForwarderZone -Name 'blob.core.windows.net' -MasterServers ${azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint.ip_configurations.0.private_ip_address} -PassThru"
  onprem_configure_dns_command3  = "Add-DnsServerConditionalForwarderZone -Name ${var.core_hub_active_directory_domain} -MasterServers ${azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint.ip_configurations.0.private_ip_address} -PassThru"
  core_hub_configure_dns_command   = "Add-DnsServerConditionalForwarderZone -Name ${var.onprem_active_directory_domain} -MasterServers ${azurerm_private_dns_resolver_inbound_endpoint.inbound_endpoint.ip_configurations.0.private_ip_address} -PassThru"
  shutdown_command              = "shutdown -r -t 60"
  exit_code_hack                = "exit 0"
  onprem_powershell_command     = "${local.import_command}; ${local.onprem_password_command}; ${local.install_ad_command}; ${local.onprem_configure_ad_command}; ${local.configure_dns_command}; ${local.onprem_configure_dns_command}; ${local.onprem_configure_dns_command2}; ${local.onprem_configure_dns_command3}; ${local.shutdown_command}; ${local.exit_code_hack}"
